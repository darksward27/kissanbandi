...
import { User, Lock, ArrowRight, Loader, EyeIcon, Eye, EyeClosed, Shield, AlertTriangle, Home } from 'lucide-react';
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <div className="mt-1 text-sm text-red-700">
                  <p>This is the customer login portal. Admin users should access the admin panel separately.</p>
                </div>
              </div>
            </div>
          </div>
